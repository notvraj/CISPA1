...
void encryption( int **matrixKey, int size, char *plaintext ){
...
int main(char* key, char* text) {

    int size;
    int** matrix = readKey(key, &size);
    ...
    encryption(matrix, size, plaintext);
